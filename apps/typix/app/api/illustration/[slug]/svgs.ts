...
const bar = (
  ...
  r(x, y, w, h, { rx, fill, op: undefined, opacity: op } as RectOpts & {
    op?: number;
  });
  ...
  formatting: (c, a) =>
    svg(
      [
        ...
        r(CX + 40, CY + TOOLBAR_H - 12, 120, 20, {
          rx: 6,
          fill: c,
          fillOpacity: 0.08,
          stroke: c,
        ...
        ...[0, 1, 2, 3].map((i) =>
          r(CX + 52 + i * 16, CY + TOOLBAR_H - 6, 10, 8, {
            rx: 2,
            fill: i < 2 ? a : c,
        ...
        ...[0, 1, 2, 3].map((i) => {
          ...
          return [
            sel
              ...
              : "",
            r(CX + 98, my + 3, 80 - i * 8, 6, {
              rx: 3,
              fill: sel ? a : c,
              opacity: sel ? 0.8 : 0.28,
            }),
            // icon placeholder
            r(CX + 86, my + 2, 8, 8, {
              rx: 2,
  ...
  "character-limit": (c, a) =>
    svg(
      [
        ...
        // progress fill — ~78%
        r(CX, CY + TOOLBAR_H + 74, Math.round(CW * 0.78), 8, {
          rx: 4,
          fill: a,
          opacity: 0.75,
        }),
        // count badge
        r(CX + CW - 52, CY + TOOLBAR_H + 88, 52, 14, {
          rx: 7,
          fill: a,
          fillOpacity: 0.12,
          stroke: a,
  ...
  "max-length": (c, a) =>
    svg(
      [
        ...
        r(CX + 194, CY + TOOLBAR_H + 54, 2, 12, {
          rx: 1,
          fill: a,
          opacity: 0.9,
        }),
        // full progress bar (limit reached)
        r(CX, CY + TOOLBAR_H + 74, CW, 8, {
          rx: 4,
          fill: c,
          fillOpacity: 0.08,
        }),
        ...
        // "MAX" badge
        r(CX + CW - 42, CY + TOOLBAR_H + 88, 42, 14, {
          rx: 7,
          fill: a,
          fillOpacity: 0.18,
          stroke: a,
        ...
        ...[0, 1, 2].map((i) => {
          ...
          return [
            ...
            r(CX + 18, y, CW - 18, 40, {
              rx: 6,
              fill: drag ? a : c,
              fillOpacity: drag ? 0.08 : 0.05,
              stroke: drag ? a : c,
              strokeWidth: drag ? 1.5 : 1,
    ...
    svg(
      [
        ...
        ...[1, 2, 3, 4].flatMap((row) =>
          [0, 1, 2, 3].map((col) =>
            b(
              CX + Math.round((CW * col) / 4) + 8,
              CY + 4 + row * 26 + 9,
              Math.round(CW / 4) - 22 - (col + row) * 3,
              c,
              0.22,
              6,
              3
  ...
  "ai-autocomplete": (c, a) =>
    svg(
      [
        ...
        // cursor
        r(CX + 112, CY + TOOLBAR_H + 30, 2, 12, {
          rx: 1,
          fill: c,
          opacity: 0.7,
        }),
        // "Tab to accept" pill
        r(CX + 116, CY + TOOLBAR_H + 46, 86, 18, {
          rx: 9,
          fill: a,
          fillOpacity: 0.1,
          stroke: a,
        ...
        // suggestion popup
        r(CX + 100, CY + TOOLBAR_H + 70, 160, 52, {
          rx: 8,
          fill: c,
          fillOpacity: 0.07,
          stroke: c,
      ...
      [
        ...
        ...[
          ...
          r(x, CY + 30 - h / 2, 9, h, {
            rx: 4.5,
            fill: a,
            opacity: +(0.15 + (h / 44) * 0.45).toFixed(2),
          })
        ),
        // transcription text
    ...
    svg(
      [
        ...
        ...[
          ...
          return [
            active
              ? r(WX + 4, sy - 3, 68, 16, { rx: 4, fill: a, fillOpacity: 0.15 })
              : "",
