...
| `extension_nodes` | `ReadonlyArray<Klass<LexicalNode> \| LexicalNodeReplacement>` | `[]` | Custom nodes to register |
...
When you install extensions that provide custom nodes, add them to `extension_nodes`:
