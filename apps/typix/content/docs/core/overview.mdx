...
| [`useEditor`](/docs/core/hooks/use-editor) | Access the Lexical editor + isEmpty state |
...
// Hooks
import { useTypixEditor, useEditor, useActiveFormats, useRange } from '@typix-editor/react';
