...
:root {
  ...
  --typix-token-comment: slategray;
  --typix-token-punctuation: #999;
  --typix-token-property: #905;
  --typix-token-selector: #690;
  --typix-token-operator: #9a6e3a;
  --typix-token-attr: #07a;
  --typix-token-variable: #e90;
  --typix-token-function: #dd4a68;
}

.typix-token--comment { color: var(--typix-token-comment); }
.typix-token--punctuation { color: var(--typix-token-punctuation); }
.typix-token--property { color: var(--typix-token-property); }
.typix-token--selector { color: var(--typix-token-selector); }
.typix-token--operator { color: var(--typix-token-operator); }
.typix-token--attr { color: var(--typix-token-attr); }
.typix-token--variable { color: var(--typix-token-variable); }
.typix-token--function { color: var(--typix-token-function); }`,
  },
];
