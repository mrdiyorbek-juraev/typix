    ...
    <div style={{ padding: 80 }}>
      <DropdownMenu>
        ...
        <DropdownMenuContent>
          ...
          <DropdownMenuItem>
            Profile
            <DropdownMenuShortcut><Kbd>⌘P</Kbd></DropdownMenuShortcut>
          </DropdownMenuItem>
          <DropdownMenuItem>
            Settings
            <DropdownMenuShortcut><Kbd>⌘,</Kbd></DropdownMenuShortcut>
          </DropdownMenuItem>
          <DropdownMenuSeparator />
          ...
          <DropdownMenuItem className="text-destructive focus:text-destructive">
            Log out
            <DropdownMenuShortcut><Kbd>⇧⌘Q</Kbd></DropdownMenuShortcut>
          </DropdownMenuItem>
        </DropdownMenuContent>
      </DropdownMenu>
    </div>
