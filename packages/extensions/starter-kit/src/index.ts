...
export { UnderlineExtension, type UnderlineConfig } from './extensions/underline'
export { StrikeExtension, type StrikeConfig } from './extensions/strike'
export { SubscriptExtension, type SubscriptConfig } from './extensions/subscript'
export { SuperscriptExtension, type SuperscriptConfig } from './extensions/superscript'
export { HighlightExtension, type HighlightConfig } from './extensions/highlight'
export { HeadingExtension, type HeadingConfig } from './extensions/heading'
export { BlockquoteExtension, type BlockquoteConfig } from './extensions/blockquote'
export { ListExtension, type ListConfig } from './extensions/list'
export { CodeExtension, type CodeConfig } from './extensions/code'
export { AlignmentExtension, type AlignmentConfig, type AlignmentValue } from './extensions/alignment'
