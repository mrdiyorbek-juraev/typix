...
export const AlignmentExtension = withTypixMeta(
  defineExtension({
  ...
  }),
  {
    commands: () => ({
      setAlignment:
        (attrs: { alignment: AlignmentValue }) => (editor: LexicalEditor) =>
          editor.dispatchCommand(TYPIX_SET_ALIGNMENT, attrs),
      alignLeft: () => (editor: LexicalEditor) =>
        editor.dispatchCommand(TYPIX_ALIGN_LEFT, undefined),
      alignCenter: () => (editor: LexicalEditor) =>
        editor.dispatchCommand(TYPIX_ALIGN_CENTER, undefined),
      alignRight: () => (editor: LexicalEditor) =>
        editor.dispatchCommand(TYPIX_ALIGN_RIGHT, undefined),
      alignJustify: () => (editor: LexicalEditor) =>
        editor.dispatchCommand(TYPIX_ALIGN_JUSTIFY, undefined),
      alignStart: () => (editor: LexicalEditor) =>
        editor.dispatchCommand(TYPIX_ALIGN_START, undefined),
      alignEnd: () => (editor: LexicalEditor) =>
        editor.dispatchCommand(TYPIX_ALIGN_END, undefined),
    }),
    shortcuts: [
