...
export const HistoryExtension = withTypixMeta(
  defineExtension({
    name: "@typix/history",
  ...
  {
    commands: () => ({
      undo: () => (editor: LexicalEditor) =>
        editor.dispatchCommand(TYPIX_UNDO, undefined),
      redo: () => (editor: LexicalEditor) =>
        editor.dispatchCommand(TYPIX_REDO, undefined),
    }),
    shortcuts: [
