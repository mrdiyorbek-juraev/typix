...
export const FontSizeExtension = withTypixMeta(
  defineExtension({
  ...
  {
    commands: () => ({
      setFontSize: (attrs: { size: number }) => (editor: LexicalEditor) =>
        editor.dispatchCommand(TYPIX_SET_FONT_SIZE, attrs),
      increaseFontSize:
        (attrs?: { step?: number }) => (editor: LexicalEditor) =>
          editor.dispatchCommand(TYPIX_INCREASE_FONT_SIZE, attrs),
      decreaseFontSize:
        (attrs?: { step?: number }) => (editor: LexicalEditor) =>
          editor.dispatchCommand(TYPIX_DECREASE_FONT_SIZE, attrs),
      resetFontSize: () => (editor: LexicalEditor) =>
        editor.dispatchCommand(TYPIX_RESET_FONT_SIZE, undefined),
    }),
  }
);
