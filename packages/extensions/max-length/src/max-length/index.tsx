...
import { $getSelection, $isRangeSelection, type EditorState, RootNode as RootNodeClass, type RootNode } from 'lexical';
    ...
    useEffect(() => {
        ...
        const unregister = editor.registerNodeTransform(
            ...
            (rootNode: RootNode) => {
                ...
                const warningLimit = Math.floor(props.maxLength * props.warningThreshold);
                if (
