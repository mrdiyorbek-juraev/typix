...
export type FloatingLinkUIProps = {
  /**
   * The element used as the anchor for positioning the floating editor.
...
/** @deprecated Use FloatingLinkUIProps */
export type FloatingLinkExtensionProps = FloatingLinkUIProps;
