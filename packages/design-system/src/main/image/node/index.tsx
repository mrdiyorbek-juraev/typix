...
/**
 * Plain data descriptor returned by the headless ImageNode.decorate().
 * The CLI-scaffolded node subclass overrides decorate() to return JSX (or
 * whatever the framework adapter needs), using this shape as its props source.
 */
